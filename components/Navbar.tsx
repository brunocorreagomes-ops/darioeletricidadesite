  ...
  return (
    <nav className="bg-brand-dark text-white sticky top-0 z-50 shadow-lg border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24"> {/* Increased height for the logo */}
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <button
                ...
                className="bg-brand-accent hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 flex items-center gap-2"
              >
                <Zap className="h-5 w-5 fill-current" /> Orçamento Grátis
              </button>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-brand-dark border-t border-gray-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            >
              <Zap className="h-5 w-5 fill-current" /> Pedir Orçamento Grátis
            </button>
          </div>
        </div>
      )}
